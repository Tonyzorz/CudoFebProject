...
public class FebColumnCategoryvo {
	...
	public String toString() {
		return "FebColumnCategoryvo [febColumnCategoryId=" + febColumnCategoryId + ", febColumnId=" + febColumnId
				+ ", febColumnCategoryTitle=" + febColumnCategoryTitle + "]";
	}
